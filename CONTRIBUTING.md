# Contributing to ContractHub

Thank you for your interest in contributing to ContractHub! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/contracthub.git
   cd contracthub
   ```
...
ContractHub requires **Python 3.12+** and uses [`uv`](https://github.com/astral-sh/uv) (or standard `pip` / `venv`) for reproducible virtual environments.
